...
import myImage from "E:/deept-agl.github.io/src/assets/images/deep_img_hd.png"; // replace with my file name

export default function FeelingProud() {
  return (
    <div className="feeling-proud-container">
      <img src={myImage} alt="Deepti Agrawal" className="feeling-proud-image" />
    </div>
  );
}
